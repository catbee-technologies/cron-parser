...
export class CronDayOfWeek extends CronField {
  static override get min(): CronMin {
    return MIN_DAY;
  }

  static override get max(): CronMax {
    return MAX_DAY;
  }

  static override get chars(): readonly CronChars[] {
    return DAY_CHARS;
  }

  static override get validChars(): RegExp {
   ...
   */
  override get values(): DayOfWeekRange[] {
